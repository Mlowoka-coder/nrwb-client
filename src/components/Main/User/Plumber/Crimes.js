...
import AddCrime from '../../Form/Crimes/CustomerCrime';
...
const Crimes = () => {
    ...
    return ( 
        <React.Fragment>
            <MainHeading title='Crimes' buttonTitle='Add New Crime' width='1000px'>
                <MainHeading title='Register Customer Crime'/>
                <AddCrime/>
            </MainHeading>
            <Table
                data={data}
